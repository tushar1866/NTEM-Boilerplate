...
describe('User routes', () => {
    describe('POST /v1/users', () => {
        ...
        test('should return 400 error if email is already used', async () => {
            await insertUsers([admin as UserDocument, userOne as UserDocument]);
    ...
    describe('GET /v1/users', () => {
        test('should return 200 and apply the default query options', async () => {
            await insertUsers([
                userOne as UserDocument,
                userTwo as UserDocument,
                admin as UserDocument,
            ]);
    ...
    describe('GET /v1/users/:userId', () => {
        ...
        test('should return 200 and the user object if admin is trying to get another user', async () => {
            await insertUsers([userOne as UserDocument, admin as UserDocument]);
    ...
    describe('DELETE /v1/users/:userId', () => {
        test('should return 204 if data is ok', async () => {
            await insertUsers([userOne as UserDocument as UserDocument]);
